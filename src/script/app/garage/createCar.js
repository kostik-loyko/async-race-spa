...
import updateCar from './updateCarDB';
    ...
    const createCarAPI = async () => {
      ...
      const getCarNew = async (id) => {
        ...
        <div class="conteiner-car-btns">
          ...
          <h3 id="${car.id}tit" class="car-title">${car.name}</h3>
        </div>
        <div id="${car.id}cont" class="conteiner-car-car">
          ...
          <svg class="car-img" id="${car.id}" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"
            fill="${car.color}">
            <path
